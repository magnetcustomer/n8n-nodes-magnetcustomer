...
export const meetingTypeFields: INodeProperties[] = [
	...
	{ displayName: 'Page', name: 'page', type: 'number', displayOptions: { show: { operation: ['getAll'], resource: ['meetingType'] } }, default: 1 },
	{ displayName: 'Limit', name: 'limit', type: 'number', typeOptions: { minValue: 15 }, displayOptions: { show: { operation: ['getAll'], resource: ['meetingType'] } }, default: 15, description: 'Max number of results to return' },

	// create/update fields
	{ displayName: 'Name', name: 'name', type: 'string', displayOptions: { show: { operation: ['create'], resource: ['meetingType'] } }, default: '', required: true },
	{ displayName: 'Name', name: 'name', type: 'string', displayOptions: { show: { operation: ['update'], resource: ['meetingType'] } }, default: '' },

	// search
	{ displayName: 'Search', name: 'search', type: 'string', displayOptions: { show: { operation: ['search'], resource: ['meetingType'] } }, default: '' },
	{ displayName: 'Page', name: 'page', type: 'number', displayOptions: { show: { operation: ['search'], resource: ['meetingType'] } }, default: 1 },
	{ displayName: 'Limit', name: 'limit', type: 'number', typeOptions: { minValue: 15 }, displayOptions: { show: { operation: ['search'], resource: ['meetingType'] } }, default: 15, description: 'Max number of results to return' },
];
