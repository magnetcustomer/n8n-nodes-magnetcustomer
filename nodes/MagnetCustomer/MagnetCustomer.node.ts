...
import {
	...
	magnetCustomerGetCustomProperties,
	magnetCustomerResolveCustomProperties,
...
export class MagnetCustomer implements INodeType {
	description: INodeTypeDescription = {
		...
		description: 'Create and edit data in MagnetCustomer',
		defaults: {
			name: 'MagnetCustomer',
		},
		...
		requestDefaults: {
			baseURL: 'https://api.magnetCustomer.com/v1',
			url: '',
		},
		properties: [
			{
	...
	methods = {
		loadOptions: {
			...
			async getActivityTypes(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				...
				const { data } = await magnetCustomerApiRequest.call(this, 'GET', '/activityTypes', {});
			...
			async getFilters(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				...
				const { data } = await magnetCustomerApiRequest.call(
					this,
					'GET',
					'/filters',
					{},
			...
			async getOrganizationIds(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				const returnData: INodePropertyOptions[] = [];
				const { data } = await magnetCustomerApiRequest.call(this, 'GET', '/organizations', {});
			...
			async getUserIds(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				...
				const { data } = await magnetCustomerApiRequest.call(this, 'GET', '/users', {});
			...
			async getProducts(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				const { data } = (await magnetCustomerApiRequest.call(this, 'GET', '/products', {})) as {
			...
			async getDealCustomFields(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				const returnData: INodePropertyOptions[] = [];
				const { data } = await magnetCustomerApiRequest.call(this, 'GET', '/dealFields', {});
				for (const field of data) {
					if (field.key.length === 40) {
						returnData.push({
							name: field.name,
			...
			async getPersonCustomFields(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				const returnData: INodePropertyOptions[] = [];
				const { data } = await magnetCustomerApiRequest.call(this, 'GET', '/personFields', {});
				for (const field of data) {
					if (field.key.length === 40) {
						returnData.push({
							name: field.name,
			...
			async getPersons(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				const { data } = (await magnetCustomerApiRequest.call(this, 'GET', '/persons', {})) as {
					data: Array<{ id: string; name: string }>;
				};
			...
			async getLeadLabels(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				const { data } = (await magnetCustomerApiRequest.call(this, 'GET', '/leadLabels', {})) as {
					data: Array<{ id: string; name: string }>;
				};
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		if (
			...
			if (getCustomProperties) {
				customProperties = await magnetCustomerGetCustomProperties.call(this, resource);
			}
		}
			...
			try {
				if (resource === 'activity') {
					...
					if (operation === 'create') {
						...
						// https://developers.magnetCustomer.com/docs/api/v1/Leads#addLead
						...
						// https://developers.magnetCustomer.com/docs/api/v1/Leads#deleteLead
						...
						// https://developers.magnetCustomer.com/docs/api/v1/Leads#getLead
						...
						// https://developers.magnetCustomer.com/docs/api/v1/Leads#getLeads
						...
						// https://developers.magnetCustomer.com/docs/api/v1/Leads#updateLead
				...
				if (returnAll) {
					...
					if (customProperties !== undefined) {
						magnetCustomerEncodeCustomProperties(customProperties, body);
					}
		...
		if (customProperties !== undefined) {
			for (const item of returnData) {
				magnetCustomerResolveCustomProperties(customProperties, item);
			}
		}
