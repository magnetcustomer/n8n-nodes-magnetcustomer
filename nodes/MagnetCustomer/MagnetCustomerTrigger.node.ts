...
import { magnetCustomerApiRequest } from './GenericFunctions';
...
export class MagnetCustomerTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'MagnetCustomer Trigger',
		name: 'magnetCustomerTrigger',
		icon: 'file:magnetcustomer.svg',
		group: ['trigger'],
		version: 1,
		description: 'Starts the workflow when MagnetCustomer events occur',
		defaults: {
